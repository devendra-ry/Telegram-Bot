...
from assistant_bot.config import API_URLS, CAMERA_LORAS, RES_MAP, logger
from assistant_bot.services import call_api, get_ai_response_with_stream, parse_api_error, send_message_draft
from assistant_bot.state import conversation_history, user_images
from assistant_bot.utils import parse_params
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_message = (
        "Hello.\\n\\n"
        "I'm your assistant, ready to help with your requests. "
        "Ask a question or send a command to get started.\n\n"
...
async def clear_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text("Conversation history cleared. You can start a new chat anytime.")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    draft_id = effective_message.message_id if effective_message and effective_message.message_id else random.randint(1, 2_147_483_647)
